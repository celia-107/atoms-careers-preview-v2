...
import { TechMascotScene } from './TechMascotScene'
import './TechMascotScene.css'

export function RecruitHero({ onApply }: { onApply: () => void }) {
  const content = careerStory.hero
  return <section className="recruit-hero tech-hero section-shell" aria-labelledby="hero-title">
